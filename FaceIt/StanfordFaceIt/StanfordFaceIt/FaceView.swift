...
class FaceView: UIView {
    ...
    @IBInspectable
    var mouthCurvature: Double = -1.0 // 1.0 is full smile and -1.0 is full down
    ...
    private var skullCenter: CGPoint {
        // get {
        return CGPoint(x: bounds.midX, y: bounds.midY) //convert coordinates from superview to faceView
        // }
    }

    private func pathForMouth() -> UIBezierPath {
        //calculate mouth with height offset
